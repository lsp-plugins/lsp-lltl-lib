...
#define LSP_LLTL_LIB_MICRO      5

#if defined(LSP_LLTL_LIB_PUBLISHER)
    #define LSP_LLTL_LIB_EXPORT         LSP_EXPORT_MODIFIER
    #define LSP_LLTL_LIB_IMPORT         LSP_SYMBOL_EXTERN LSP_EXPORT_MODIFIER
#elif defined(LSP_LLTL_LIB_BUILTIN) || defined(LSP_IDE_DEBUG)
    #define LSP_LLTL_LIB_EXPORT
    #define LSP_LLTL_LIB_IMPORT         LSP_SYMBOL_EXTERN
#else
    #define LSP_LLTL_LIB_EXPORT         LSP_SYMBOL_EXTERN
    #define LSP_LLTL_LIB_IMPORT         LSP_SYMBOL_EXTERN LSP_IMPORT_MODIFIER
#endif
